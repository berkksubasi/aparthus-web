  ...
  return (
    ...
    >
      ...
      <p className="text-lg sm:text-xl text-white text-center mb-6 sm:mb-10 max-w-3xl mx-auto">
        Aparthus Solutions&apos;ı ileriye taşıyan yetenekli ekip üyelerimizle tanışın.
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 sm:gap-12 animate-fade-in-up w-full max-w-6xl">
        ...
        <div className="team-member bg-white shadow-lg rounded-xl p-6 sm:p-8 text-center hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2">
          ...
          <p className="text-primary font-medium mb-4">CEO & CTO</p>
          <p className="text-gray-600 mb-4 sm:mb-6">
            Berk, profesyonel yazılım geliştirme dünyasında 5 yıllık deneyime sahip bir girişimcidir. Hem web hem de mobil platformlarda yenilikçi çözümler üretme konusundaki yetkinliği ile bilinir.
          </p>
          {/* Subtext */}
          <p className="text-gray-500 text-sm">&quot;Teknolojiyi kullanarak geleceğin yaşam alanlarını inşa ediyoruz.&quot;</p>
